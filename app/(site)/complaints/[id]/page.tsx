        ...
        <div className="absolute inset-0 flex flex-col justify-end">
          <div className="mx-auto w-full max-w-6xl px-4 pb-12 sm:px-6">
            <div className="mb-5 flex flex-wrap items-center gap-3">
              <span className="inline-flex items-center gap-1.5 rounded-full bg-white/10 px-2.5 py-1 text-[11px] font-bold uppercase tracking-widest text-white backdrop-blur-md ring-1 ring-white/20">
            ...
            <h1 className="text-3xl font-black leading-[1.1] tracking-tighter text-white md:text-5xl lg:text-6xl max-w-3xl">
              {complaint.title}
            </h1>
